...
class Plotter:
    ...
    def plot_metric_density(self, results, metrics=('accuracy', 'f1_score', 'roc_auc')):
        ...
        for i, metric in enumerate(metrics):
            ...
            if i == 0:
                ax.legend()
        plt.tight_layout()
        plt.savefig("../outputs/plot_metric_density.png")
        plt.show()
    ...
    def plot_evaluation_metric_over_replications(self, all_metric_results, title, metric_name):
        ...
        plt.legend()
        plt.savefig("../outputs/plot_evaluation_metric_over_replication_" + metric_name + ".png")
        plt.show()
    ...
    def plot_confusion_matrices(self, confusion_matrices):
        ...
        for model_name, matrix in confusion_matrices.items():
            ...
            plt.savefig("../outputs/plot_confusion_matrices" + model_name + ".png")
            plt.show()
